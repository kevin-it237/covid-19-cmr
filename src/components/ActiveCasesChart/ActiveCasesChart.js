    ...
    displayChart = () => {
        Highcharts.chart('covid-cmr-active-chart', {
            ...
            xAxis: {
                ...
                "Mar 26","Mar 27","Mar 28","Mar 29","Mar 30","Mar 31","Apr 01","Apr 02","Apr 03","Apr 04","Apr 05","Apr 06","Apr 07","Apr 08","Apr 09","Apr 10"] 
            },
            yAxis: {
                title: {
                    text: 'Total des Cas'
            ...
            series: [{
                name: 'Cas',
                data: [0,0,0,0,2,2,2,2,2,2,2,2,3,4,5,10,13,13,25,38,38,54,63,72,72,87,87,128,128,182,217,289,484,529,624,632,616,660,681,730,710],
                zoneAxis: 'x',
                color: '#00DDDD',
                lineWidth: 5,
            }]
