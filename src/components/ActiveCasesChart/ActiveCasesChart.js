...
class ActiveCase extends React.Component {
    ...
    displayChart = () => {
        Highcharts.chart('covid-cmr-active-chart', {
            ...
            series: [{
                name: 'Cas',
                data: [0,0,0,0,2,2,2,2,2,2,2,2,3,4,5,10,13,13,25,38,38,54,63,72,72,87,87,128,128,182,217,289,484,529,624,632,616,660,681,730,710,710,720,720,704,666,810],
                zoneAxis: 'x',
                color: '#00DDDD',
                lineWidth: 5,
            }]
