    ...
    displayChart = () => {
        Highcharts.chart('covid-cmr-active-chart', {
            ...
            xAxis: {
                ...
                "Apr 08","Apr 09","Apr 10","Apr 11","Apr 12","Apr 13","Apr 14","Apr 15","Apr 16","Apr 17","Apr 18","Apr 19","Apr 20","Apr 21","Apr 22","Apr 23","Apr 24"] 
            },
            yAxis: {
                title: {
                    text: 'Total des Cas'
            ...
            series: [{
                ...
                data: [0,0,0,0,2,2,2,2,2,2,2,2,3,4,5,10,13,13,25,38,38,54,63,72,72,87,87,128,128,182,217,289,484,
                    529,624,632,616,660,681,730,710,710,720,720,704,666,810,818,670,670,724,724,724,623,668],
                zoneAxis: 'x',
                color: '#00DDDD',
                lineWidth: 5,
            }]
