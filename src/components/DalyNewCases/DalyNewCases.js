    ...
    displayChart = () => {
        Highcharts.chart('covid-cmr-dayly-chart', {
            ...
            xAxis: {
                ...
                "Apr 07","Apr 08","Apr 09","Apr 10","Apr 11","Apr 12","Apr 13","Apr 14","Apr 15","Apr 16","Apr 17","Apr 21"]
            },
            yAxis: {
                title: {
                    text: 'Total des Cas'
            ...
            series: [{
                name: 'Cas',
                data: [0,1,1,1,5,3,0,14,13,0,16,10,9,0,16,0,48,0,54,40,73,203,46,95,8,27,45,73,17,0,12,0,16,0,148,21,147],
                zoneAxis: 'x',
                color: '#FF9900',
                lineWidth: 5,
            }]
