    ...
    displayChart = () => {
        Highcharts.chart('covid-cmr-chart', {
            ...
            xAxis: {
                ...
                "Apr 01","Apr 02","Apr 03","Apr 04","Apr 05","Apr 06","Apr 07","Apr 08","Apr 09","Apr 10","Apr 11","Apr 12","Apr 13","Apr 14"] 
            },
            yAxis: {
                title: {
                    text: 'Total des Cas'
            ...
            series: [{
                name: 'Cas',
                data: [0,0,0,0,0,2,2,2,2,2,2,2,2,3,4,5,10,13,13,27,40,40,56,66,75,75,91,91,139,139,193,233,306,509,555,650,658,685,730,803,820,820,832,832,848],
                zoneAxis: 'x',
                color: '#33CCFF',
                lineWidth: 5,
            }]
