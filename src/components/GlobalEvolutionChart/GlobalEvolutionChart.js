    ...
    displayChart = () => {
        Highcharts.chart('covid-cmr-chart', {
            ...
            xAxis: {
                ...
                "Apr 12","Apr 13","Apr 14","Apr 15","Apr 16","Apr 17","Apr 18","Apr 19","Apr 20","Apr 21","Apr 22","Apr 23","Apr 24"]
            },
            yAxis: {
                title: {
                    text: 'Total des Cas'
            ...
            series: [{
                ...
                data: [0,0,0,0,0,2,2,2,2,2,2,2,2,3,4,5,10,13,13,27,40,40,56,66,75,75,91,91,139,139,193,233,306,509,555,650,658,
                    685,730,803,820,820,832,832,848,848,996,996,1017,1017,1163,1163,1163,1334,1430],
                zoneAxis: 'x',
                color: '#33CCFF',
                lineWidth: 5,
            }]
